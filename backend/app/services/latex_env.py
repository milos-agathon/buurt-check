...
def render_dossier(
    *,
    ...
    comparison_chart_blocks: list[dict[str, Any]] | None = None,
    ...
    shadow_caption: str | None = None,
    shadow_time_labels: list[str] | None = None,
    neighborhood_sections: list[dict[str, Any]] | None = None,
    neighborhood_urbanization_label: str | None = None,
    climate_disclosure: str | None = None,
    ...
    return render_template(
        ...
        shadow_caption=shadow_caption,
        shadow_time_labels=shadow_time_labels,
        neighborhood_sections=neighborhood_sections,
        neighborhood_urbanization_label=neighborhood_urbanization_label,
