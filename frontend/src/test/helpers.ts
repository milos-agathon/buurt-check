...
export function makeNeighborhoodStatsResponse(
  ...
  return {
    ...
    stats: {
      ...
      population_density: { value: 15000, unit: 'per km²', available: true, precision: 0 },
      avg_household_size: { value: 1.8, available: true, precision: 1 },
      single_person_pct: { value: 55, unit: '%', available: true, precision: 1 },
      age_profile: {
        age_0_24: 18,
        age_25_64: 65,
        age_65_plus: 17,
      },
      owner_occupied_pct: { value: 35, unit: '%', available: true, precision: 1 },
      avg_property_value: { value: 520000, unit: '€', available: true, precision: 0 },
